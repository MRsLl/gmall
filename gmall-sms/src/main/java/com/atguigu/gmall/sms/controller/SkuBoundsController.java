...
public class SkuBoundsController {
    ...
    @ApiOperation("根据skuId 查询sku 所有营销信息")
    ...
    @ApiOperation("保存sku 促销信息")
    public ResponseVo saveSkuSaleInfo(@RequestBody SkuSaleDto skuSaleDto){
        skuBoundsService.saveSkuSaleInfo(skuSaleDto);
