...
public class WareSkuController {
    ...
    public ResponseVo<List<SkuLockVo>> checkAndLockWare(@RequestBody List<SkuLockVo> skuLockVos) {
        List<SkuLockVo> lockVos = wareSkuService.checkAndLockWare(skuLockVos);
