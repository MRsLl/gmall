...
public class PmsOssController {
    ...
    String accessId = "LTAI4G7h4Ujt8zoQL2ixMavW"; // 请填写您的AccessKeyId。
    String accessKey = "VskFsL0TCFaaGzrGsDPTVhOyFqbLdt"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "gmall-mrsl"; // 请填写您的 bucketname 。
