...
public class SpuController {
    ...
    @ApiOperation("根据分类分页查询spu")
    public ResponseVo<PageResultVo> querySpuByPageAndCategoryId(
            @PathVariable("categoryId") Long categoryId,
            PageParamVo pageParamVo){
        PageResultVo pageResultVo = spuService.querySpuByPageAndCategoryId(categoryId,pageParamVo);
...
*/
     ...
     */
    @PostMapping
    @ApiOperation("保存所有新增的spu 信息")
    public ResponseVo<Object> save(@RequestBody SpuVo spuVo){
		spuService.saveAllInformation(spuVo);
    ...
    public ResponseVo update(@RequestBody SpuEntity spu){
		...
		rabbitTemplate.convertAndSend("spu.update",spu.getId());
