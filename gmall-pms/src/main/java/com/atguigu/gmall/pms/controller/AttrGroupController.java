...
public class AttrGroupController {
    ...
    @ApiOperation("根据分类分页查询规格参数分组")
    public ResponseVo<List<AttrGroupEntity>> queryAttrBrandByCategoryId
            (@PathVariable("cid") Long categoryId) {
        List<AttrGroupEntity> attrGroupEntities =
                attrGroupService.list(new QueryWrapper<AttrGroupEntity>().eq("category_id", categoryId));
